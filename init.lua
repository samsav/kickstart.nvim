...
-- Enable absolute line numbers for current line and relative numbers for other lines
vim.opt.number = true
...
-- Ask to save changes when closing a buffer with unsaved changes
...
require('lazy').setup({
  ...
  {
    -- See installed themes: `:Telescope colorscheme`.
